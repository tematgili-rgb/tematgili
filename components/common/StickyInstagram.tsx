...
export default function StickyInstagram() {
  ...
  return (
    <a
      ...
      className="fixed bottom-24 right-6 z-40 inline-flex items-center justify-center p-4 rounded-full shadow-2xl bg-gradient-to-tr from-pink-300 to-pink-500 text-white hover:scale-110 transition-all"
    >
      <svg
